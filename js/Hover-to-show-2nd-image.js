document.addEventListener("DOMContentLoaded", function () {
    // Check if we're on the homepage or a label page
    if (
        window.location.pathname === "/" || // Homepage
        window.location.pathname === "/index.html" || // Homepage (explicit filename)
        window.location.pathname.startsWith("/search/label") // Label pages
    ) {
